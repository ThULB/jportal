...
public class DebugMCRLayoutUtils {
    ...
    private static final String NAVI_LOC = MCRConfiguration.instance().getString("MCR.navigationFile", NAV_LOC_DEFAULT)
                .replace('/', File.separatorChar);

    private static final File NAVFILE = new File(NAVI_LOC);
