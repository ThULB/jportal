/*
 * 
 * $Revision: 16387 $ $Date: 2010-01-20 10:30:08 +0100 (Mi, 20 Jan 2010) $
 *
 ...
 * @version $Revision: 16387 $ $Date: 2010-01-20 10:30:08 +0100 (Mi, 20 Jan 2010) $
 */
final public class MCRDerivate extends MCRBase {
    ...
    public final void deleteFromDatastore(String id) throws MCRPersistenceException {
        ...
        if(!uid.equals(MCRConfiguration.instance().getString("MCR.Users.Superuser.UserName"))) {
            String msg = "User '" + uid + "' tried to delete derivate '"+id + "'!";
            MCRPersistenceException mcrPersistenceException = new MCRPersistenceException(msg);

            String sender = "derivate@uni-jena.de";
            String subject = "derivate deleting";
            ArrayList<String> recList = new ArrayList<String>();
            recList.add("chi@thulb.uni-jena.de");
            MCRMailer.send(sender, recList, subject, mcrPersistenceException.toString(), false);

            throw mcrPersistenceException;
        }
