...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <td id="iview-roller">
                                            <div align="center">
                                                <xsl:if test="$MCR.Module-iview.display = 'normal'">
                                                    <a class="dummyview3" title="{i18n:translate('component.iview.advMenu')}"
                                        ...
                                        <td id="iview-simplesize">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="iview-simplewidth" title="{i18n:translate('component.iview.adjustWidth')}"
                                                    ...
                                                    <table id="iview-displayswitch" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="iview-displayswitchthumbs" title="{i18n:translate('component.iview.thumbs')}"
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="iview-displayswitchpicture" title="{i18n:translate('component.iview.viewPic')}"
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="iview-displayswitchtext" title="{i18n:translate('component.iview.overview')}"
                                                    ...
                                                    <table id="iview-viewoptions" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$MCR.Module-iview.embedded='true'">
                                                                        <a class="iview-viewoptionssmall"
                                                                            title="{concat(i18n:translate('component.iview.scaleDown'),i18n:translate('component.iview.inactive'))}"
                                                                            href="#" align="middle">
                                                                            <xsl:text disable-output-escaping="yes">
                                                                    &amp;nbsp;</xsl:text>
                                                                        </a>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <a class="iview-viewoptionssmall" title="{i18n:translate('component.iview.scaleDown')}"
                                                            ...
                                                            <td>
                                                                <xsl:choose>
                                                                    <xsl:when test="$MCR.Module-iview.embedded='true'">
                                                                        <a class="iview-viewoptionslarg" title="{i18n:translate('component.iview.scaleUp')}"
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <a class="iview-viewoptionslarg"
                                                                            title="{concat(i18n:translate('component.iview.scaleUp'),i18n:translate('component.iview.inactive'))}"
                                                                            href="#" align="middle">
                                                                            <xsl:text disable-output-escaping="yes">
                                                                    &amp;nbsp;</xsl:text>
                                                                        </a>
                                    ...
                                    <xsl:if test="$MCR.Module-iview.display = 'extended' ">
                                        <tr id="iview-enhanced">
                                            <td id="iview-smalllogo">
                                                <div align="center">
                                                    <a class="dummyview2" title="{i18n:translate('component.iview.hideAdvMenu')}"
    ...
    <xsl:template name="image.info">
        <xsl:param name="node" />
        <p>
            <xsl:value-of select="concat(i18n:translate('component.iview.name'),':')" />
            ...
            <xsl:value-of select="concat(i18n:translate('component.iview.fileSize'),':')" />
            <xsl:value-of select="size" />
            <xsl:value-of select="concat(i18n:translate('component.iview.bytes'),':')" />
            <br />
            <xsl:value-of select="concat(i18n:translate('component.iview.format'),':')" />
            <xsl:value-of select="contentType" />

            <br />
            <xsl:value-of select="concat(i18n:translate('component.iview.imageSize'),':')" />
            <xsl:value-of select="/mcr-module/iview/header/origWidth" />
            x
            <xsl:value-of select="/mcr-module/iview/header/origHeight" />
            px
            <br />
            <xsl:value-of select="concat(i18n:translate('component.iview.lastChanged'),':')" />
            ...
            <tr>
                <td>
                    <a align="middle"
                        ...
                        title="{i18n:translate('component.iview.zoomOut')}" class="iview-resizeout">
                        <xsl:text disable-output-escaping="yes">
                            &amp;nbsp;</xsl:text>
                    </a>
                </td>
                <td>
                    <a align="middle"
                        href="{concat($iview.home,$fileToBeDisplayedPath,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.navi.zoom=+0.2')}"
                        title="{i18n:translate('component.iview.zoomIn')}" class="iview-resizein">
                        <xsl:text disable-output-escaping="yes">
                            &amp;nbsp;</xsl:text>
                    </a>
                </td>
                ...
                <td>
                    ...
                    <xsl:choose>
                        <xsl:when test="$fileToBeDisplayedPath.first != ''">
                            ...
                            <a class="iview-navigationfirst" title="{i18n:translate('component.iview.firstPic')}" href="{$fileToBeDisplayedPath.first.link}"
                                align="middle">
                                <xsl:text disable-output-escaping="yes">
                                    &amp;nbsp;</xsl:text>
                            </a>
                ...
                <td>
                    ...
                    <xsl:choose>
                        <xsl:when test="$fileToBeDisplayedPath.previous != ''">
                            ...
                            <a class="iview-navigationback" title="{i18n:translate('component.iview.prevPic')}" href="{$fileToBeDisplayedPath.previous.link}"
                                align="middle">
                                <xsl:text disable-output-escaping="yes">
                                    &amp;nbsp;</xsl:text>
                            </a>
                ...
                <td>
                    ...
                    <xsl:choose>
                        <xsl:when test="$fileToBeDisplayedPath.next != ''">
                            ...
                            <a class="iview-navigationforward" title="{i18n:translate('component.iview.nextPic')}" href="{$fileToBeDisplayedPath.next.link}"
                                align="middle">
                                <xsl:text disable-output-escaping="yes">
                                    &amp;nbsp;</xsl:text>
                            </a>
                ...
                <td>
                    ...
                    <xsl:choose>
                        <xsl:when test="$fileToBeDisplayedPath.last != ''">
                            ...
                            <a class="iview-navigationlast" title="{i18n:translate('component.iview.lastPic')}" href="{$fileToBeDisplayedPath.last.link}"
                                align="middle">
                                <xsl:text disable-output-escaping="yes">
                                    &amp;nbsp;</xsl:text>
                            </a>
