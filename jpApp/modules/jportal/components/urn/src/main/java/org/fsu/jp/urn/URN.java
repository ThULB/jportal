...
public class URN {
     ...
     * should subclass {@link fsu.archiv.mycore.urn.URN} and override this
     * method.
     * 
    ...
    public void normalize() {
        if (this.hasChecksumAttached() == false)
            return;
        namespaceSpecificPart = namespaceSpecificPart.substring(0,
                namespaceSpecificPart.length() - 1);
    }
    ...
    public static void main(String[] arg) throws Exception {
        URN newURN = UrmelURNProvider.generateUrmelURN();
        System.out.println(newURN);
        System.out.println(newURN.hasChecksumAttached());
        newURN.attachChecksum();
        System.out.println(newURN);
        System.out.println(newURN.hasChecksumAttached());
    }
}