          ...
          <xsl:when test="$mcrobj/metadata/creatorlinks/creatorlink">
            ...
            <xsl:call-template name="personlink">
              <xsl:with-param name="nodes"
                select="$mcrobj/metadata/creatorlinks/creatorlink" />
      ...
      <td colspan="3" class="description">
        <div class="description">
          <xsl:variable name="description">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="$mcrobj/metadata/descriptions/description" />
            </xsl:call-template>
          </xsl:variable>
        ...
        <span>
          ...
          <xsl:call-template name="printClass">
            <xsl:with-param name="nodes"
              select="$mcrobj/metadata/formats/format" />
            <xsl:with-param name="host" select="$host" />
          </xsl:call-template>
          ,
          <!-- type -->
          <xsl:call-template name="printClass">
            <xsl:with-param name="nodes"
              select="$mcrobj/metadata/types/type" />
            <xsl:with-param name="host" select="$host" />
          </xsl:call-template>
          ,
    ...
    <table id="metaData" cellpadding="0" cellspacing="0">
      ...
      <xsl:if test="./structure/children">
        <tr>
          <td class="metaname">
            <xsl:value-of
              select="i18n:translate('metaData.document.title')" />
          </td>
          <td class="metavalue">
      ...
      <xsl:if test="./metadata/identifiers">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.identifier'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/identifiers/identifier" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:choose>
        <xsl:when test="./metadata/creatorlinks">
          <tr>
            <td valign="top" class="metaname">
              <xsl:value-of
                select="concat(i18n:translate('metaData.document.creator'),' :')" />
            </td>
            <td class="metavalue">
              <xsl:call-template name="personlink">
                <xsl:with-param name="nodes"
                  select="./metadata/creatorlinks/creatorlink" />
        ...
        <xsl:when test="./metadata/creators">
          <tr>
            ...
            <td class="metavalue">
              <xsl:call-template name="printI18N">
                <xsl:with-param name="nodes"
                  select="./metadata/creators/creator" />
              </xsl:call-template>
            </td>
          </tr>
        </xsl:when>
        ...
        <xsl:when test="./metadata/publishers">
          <tr>
            ...
            <td class="metavalue">
              <xsl:call-template name="printI18N">
                <xsl:with-param name="nodes"
                  select="./metadata/publishers/publisher" />
              </xsl:call-template>
            </td>
          </tr>
        </xsl:when>
        ...
        <xsl:when test="./metadata/contributors">
          <tr>
            ...
            <td class="metavalue">
              <xsl:call-template name="printI18N">
                <xsl:with-param name="nodes"
                  select="./metadata/contributors/contributor" />
              </xsl:call-template>
            </td>
          </tr>
        </xsl:when>
      ...
      <xsl:if test="./metadata/origins">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.origin'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes"
                select="./metadata/origins/origin" />
              <xsl:with-param name="host" select="$obj_host" />
            </xsl:call-template>
          </td>
        </tr>
      ...
      <xsl:if test="./metadata/dates">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.date'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:variable name="selectLang">
              <xsl:choose>
                <xsl:when
                  test="/mcr_result/mycoreobject/metadata/dates/date[lang($CurrentLang)]">
            ...
            <xsl:for-each
              ...
              <xsl:choose>
                ...
                <xsl:when test="@type = 'submit'">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.submittedAt'),' :')" />
                </xsl:when>
                <xsl:when test="@type = 'accept'">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.acceptedAt'),' :')" />
                </xsl:when>
                <xsl:when test="@type = 'decide'">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.decidedAt'),' :')" />
                </xsl:when>
              </xsl:choose>
              <xsl:call-template name="formatISODate">
      ...
      <xsl:if test="./structure/derobjects">
        ...
        <tr>
          <td class="metaname" style="vertical-align:top;">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.derivate'),' :')" />
          </td>
          <td class="metavalue">
          <xsl:if test="$objectHost != 'local'">
      ...
      <xsl:if test="./metadata/subjects">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.subject'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes"
      ...
      <xsl:if test="./metadata/types">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.type'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes"
                select="./metadata/types/type" />
              <xsl:with-param name="host" select="$obj_host" />
            </xsl:call-template>
          </td>
        </tr>
      ...
      <xsl:if test="./metadata/formats">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.format'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes"
                select="./metadata/formats/format" />
              <xsl:with-param name="host" select="$obj_host" />
            </xsl:call-template>
          </td>
        </tr>
          ...
          <tr>
            <xsl:choose>
              <xsl:when test="position() = 1">
                <td valign="top" class="metaname">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.document.abstract'),' :')" />
                </td>
              </xsl:when>
              <xsl:otherwise>
                <td valign="top" class="metaname" />
          ...
          <tr>
            <xsl:choose>
              <xsl:when test="position() = 1">
                <td valign="top" class="metaname">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.document.description'),' :')" />
                </td>
              </xsl:when>
              <xsl:otherwise>
                <td valign="top" class="metaname" />
          ...
          <tr>
            <xsl:choose>
              <xsl:when test="position() = 1">
                <td valign="top" class="metaname">
                  <xsl:value-of
                    select="concat(i18n:translate('metaData.document.content'),' :')" />
                </td>
              </xsl:when>
              <xsl:otherwise>
                <td valign="top" class="metaname" />
      ...
      <xsl:if test="./metadata/keywords">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.keywords'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
      ...
      <xsl:if test="./metadata/sources">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.source'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/sources/source" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:if test="./metadata/coverages">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.coverage'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/coverages/coverage" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:if test="./metadata/relations">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.relation'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/relations/relation" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:if test="./metadata/rights">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.rights'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/rights/right" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:if test="./metadata/sizes">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.size'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/sizes/size" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
      ...
      <xsl:if test="./metadata/citations">
        <tr>
          <td valign="top" class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.document.citation'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes"
                select="./metadata/citations/citation" />
            </xsl:call-template>
          </td>
        </tr>
      </xsl:if>
  ...
  <xsl:template match="titles">
    <xsl:choose>
      <xsl:when test="title[lang($CurrentLang) and @inherited = '0']">
        <xsl:for-each
          select="title[lang($CurrentLang) and @inherited = '0']">
          <xsl:if test="position() != 1">
            <br />
          </xsl:if>
          <xsl:value-of select="." />
      ...
      <xsl:when test="title[lang($DefaultLang) and @inherited = '0']">
        <xsl:for-each
          select="title[lang($DefaultLang) and @inherited = '0']">
          <xsl:if test="position() != 1">
            <br />
          </xsl:if>
          <xsl:value-of select="." />
