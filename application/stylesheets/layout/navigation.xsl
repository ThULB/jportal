...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
				...
				<xsl:for-each select="$rootNode/item">
					...
					<xsl:if test="position() != last()">
						<td style="width:{number($spaceBetweenLinks) div 2}px;">
							...
							<td><xsl:value-of select="$seperatorChar" /></td>
      					</xsl:if>
						<td style="width:{number($spaceBetweenLinks) div 2}px;">
							<img src="{$ImageBaseURL}emtyDot1Pix.gif" alt=""></img>
						</td>
	...
	<xsl:template name="navigation.flags">
		<xsl:variable name="englishFlag">
			<img src="{$WebApplicationBaseURL}images/naviMenu/lang-en.gif" 
		...
		<xsl:variable name="germanFlag">
			<img src="{$WebApplicationBaseURL}images/naviMenu/lang-de.gif" 
	...
	<xsl:template name="addIcon">
		...
		<xsl:choose>
			...
			<xsl:when test="count(following-sibling::item) &lt; 1">
				<xsl:choose>
					<xsl:when test="$linkKind = 'line'" >
						<img src="{$WebApplicationBaseURL}images/naviMenu/empty-ri.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'normal'" >
						<img 
							src="{$WebApplicationBaseURL}images/naviMenu/line-with-element_end.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current'" >
						<img 
							src="{$WebApplicationBaseURL}images/naviMenu/line-with-element-selected_end.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current_popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}">
							...
							<img 
								src="{$WebApplicationBaseURL}images/naviMenu/minus-selected_end.gif" 
								style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}">
							...
							<img 
								src="{$WebApplicationBaseURL}images/naviMenu/minus_end.gif" 
								style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'notPopedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after(@href,'/'))}">
							...
							<img 
								src="{$WebApplicationBaseURL}images/naviMenu/plus_end.gif" 
			...
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="$linkKind = 'line'" >
						<img src="{$WebApplicationBaseURL}images/naviMenu/line.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'normal'" >
						<img 
							src="{$WebApplicationBaseURL}images/naviMenu/line-with-element.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current'" >
						<img 
							src="{$WebApplicationBaseURL}images/naviMenu/line-with-element-selected.gif" 
							style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
					</xsl:when>
					<xsl:when test="$linkKind = 'current_popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}">
							...
							<img 
								src="{$WebApplicationBaseURL}images/naviMenu/minus-selected.gif" 
								style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'popedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after((parent::node()/@href),'/'))}">
							...
							<img src="{$WebApplicationBaseURL}images/naviMenu/minus.gif" 
								style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title=""></img>
						</a>
					</xsl:when>
					<xsl:when test="$linkKind = 'notPopedUp'" >
						<a href="{concat($WebApplicationBaseURL,substring-after(@href,'/'))}">
							...
							<img src="{$WebApplicationBaseURL}images/naviMenu/plus.gif" 
								style="width:{$columnWidthIcon}px; height:{$menuPointHeigth}px;" alt="" title="" />
						</a>
					</xsl:when>
				</xsl:choose>
		                        ...
		                        <xsl:otherwise>
		                          <xsl:call-template
		                            ...
		                            <xsl:with-param name="par"
		                              select="'XSL.lastPage.SESSION'" />
		                            <xsl:with-param
		                              xmlns:encoder="xalan://java.net.URLEncoder"
		                              name="value"
		                              select="encoder:encode(@href,'UTF-8')" />
		                          </xsl:call-template>
		                        </xsl:otherwise>
		                     </xsl:choose>
	               </xsl:variable>
