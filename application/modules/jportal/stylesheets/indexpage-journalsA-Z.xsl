...
<!-- ============================================== -->
<!-- $Revision: 513 $ $Date: 2008-06-03 18:54:00 +0200 (Di, 03 Jun 2008) $ -->
<!-- ============================================== -->
      ...
      '&amp;subselect.webpage=', encoder:encode($subselect.webpage),'&amp;mode=',$mode)" />
        ...
        <tr>
            ...
            <td class="td1" valign="top" style="padding-right:5px;">
                <a href="{$WebApplicationBaseURL}receive/{col[@name='id']}">
                    <xsl:value-of select="xalan:nodeset($nameXML)/metadata/maintitles/maintitle/text()" />
                </a>

                <!--  
                    <a
                    href="{$url}&amp;_var_@href={col[@name='id']}&amp;_var_@label={$beautiLabel}
