 ...
 */
public class MCRParserXerces_Fault_Tolerant implements MCRParserInterface, ErrorHandler {

    /** The logger */
    private final static Logger LOGGER = Logger.getLogger(MCRParserXerces_Fault_Tolerant.class);
     ...
     * mycore.properties
     */
    public MCRParserXerces_Fault_Tolerant() {
    ...
    public Document parseXML(byte[] xml, boolean validate) {
    	...
    	/* change by Vu Huu Chi - 8.01.2007 
    	 * This should let CLI keep processing when a file
    	 * from derivate does not exist!
    	 */
    	InputSource source = null;
    	try {
    		source = new InputSource(new ByteArrayInputStream(xml));
		} catch (NullPointerException e) {
			String message = "This is a Hack Exception!\n" +
							 "MCRParserXerces_Fault_Tolerant.java - parseXML(byte[] xml, boolean validate)\n" +
							 "Line 181";
