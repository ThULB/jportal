...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xalan"
	...
	xmlns:aclObjType="xalan://org.mycore.access.strategies.MCRJPortalStrategy" xmlns:mcr="http://www.mycore.org/"
	xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="xlink mcr i18n acl aclObjID aclObjType"
	version="1.0">
					...
					<td colspan="2">
						...
						<table cellspacing="0" cellpadding="0" id="detailed-view">
							<xsl:call-template name="printMetaDates">
								...
								<xsl:with-param select="i18n:translate('editormask.labels.classi')" name="label"/>
							</xsl:call-template>
						</table>
						<!--7***abstract*************************************-->
						<table cellspacing="0" cellpadding="0" id="detailed-view">
	...
	<xsl:template name="addChild">
		...
		<xsl:if
			test="(aclObjType:checkPermissionOfType('jportal_jpvolume_xxxxxxxx','writedb')) and aclObjID:checkPermission($id,'writedb')">
			<tr>
