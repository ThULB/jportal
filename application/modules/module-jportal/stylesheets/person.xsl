				...
				<tr id="leaf-all">
					...
					<td id="leaf-linkarea">
						...
						<xsl:variable name="name">
							<xsl:value-of
								select="concat(xalan:nodeset($cXML)/mycoreobject/metadata/def.heading/heading/lastName/text(),', ',xalan:nodeset($cXML)/mycoreobject/metadata/def.heading/heading/firstName/text())"/>
						</xsl:variable>
