...
public class CreateITCase extends BaseIntegrationTest {
    ...
    public void createJournal() {
        ...
        // journal type
        WebElement journalTypeSelect = DRIVER.findElement(By.name("/mycoreobject/metadata/contentClassis1/contentClassi1/@categid"));
        ...
        // Tests
        TestCase.assertEquals("header does not match", "Die Horen", DRIVER.findElement(By.id("jp-maintitle")).getText());
        DRIVER.findElement(By.linkText("XML")).click();
        
//        final String md = "/mycoreobject/metadata/";
//        TestCase.assertEquals("publisher does not match", "Schiller, Friedrich von",
//                DRIVER.findElement(By.xpath(md + "participants/participant[@type='mainPublisher']")).getAttribute("xlink:title"));
//        TestCase.assertEquals("published from does not match", "1795",
//                DRIVER.findElement(By.xpath(md + "dates/date[@type='published_from']")).getText());
//        TestCase.assertEquals("published from does not match", "1797",
//                DRIVER.findElement(By.xpath(md + "dates/date[@type='published_until']")).getText());
//        TestCase.assertEquals("language from does not match", "de",
//                DRIVER.findElement(By.xpath(md + "languages/language[@classid='jportal_class_00000004']")).getAttribute("categid"));
    }
