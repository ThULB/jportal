...
if [ $SQLTYPE = 'db2' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountDB2.sh MCRXMLAUTH _author_`
fi
if [ $SQLTYPE = 'mysql' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountMySQL.sh MCRXMLAUTH _author_`
fi
if [ $SQLTYPE = 'hsqldb' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountHSQLDB.sh MCRXMLTABLE DocPortal_author_`
fi
...
if [ $SQLTYPE = 'db2' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountDB2.sh MCRXMLDOC _document_`
fi
if [ $SQLTYPE = 'mysql' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountMySQL.sh MCRXMLDOC _document_`
fi
if [ $SQLTYPE = 'hsqldb' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountHSQLDB.sh MCRXMLTABLE DocPortal_document_`
fi
...
if [ $SQLTYPE = 'db2' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountDB2.sh MCRXMLINST _institution_`
fi
if [ $SQLTYPE = 'mysql' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountMySQL.sh MCRXMLINST _institution_`
fi
if [ $SQLTYPE = 'hsqldb' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountHSQLDB.sh MCRXMLTABLE DocPortal_institution_`
fi
...
if [ $SQLTYPE = 'db2' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountDB2.sh MCRXMLDER _derivate_`
fi
if [ $SQLTYPE = 'mysql' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountMySQL.sh MCRXMLDER _derivate_`
fi
if [ $SQLTYPE = 'hsqldb' ]
then
B=`$DOCPORTAL_HOME/bin/SQLCountHSQLDB.sh MCRXMLTABLE DocPortal_derivate_`
fi
