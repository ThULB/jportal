    ...
    <table id="metaData" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes" select="./metadata/institutions/institution" />
      ...
      <xsl:if test="./metadata/profclasses">
        <tr>
          <td class="metaname">
            <xsl:value-of
              select="concat(i18n:translate('metaData.author.profClass'),' :')" />
          </td>
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes" select="./metadata/profclasses/profclass" />
              <xsl:with-param name="host" select="$obj_host" />
              <xsl:with-param name="next" select="'&lt;br /&gt;'"/>
            </xsl:call-template>
          </td>
      ...
      <xsl:if test="./metadata/nationals">
        <tr>
          ...
          <td class="metavalue">
            <xsl:call-template name="printClass">
              <xsl:with-param name="nodes" select="./metadata/nationals/national" />
              <xsl:with-param name="host" select="$obj_host" />
              <xsl:with-param name="next" select="'&lt;br /&gt;'"/>
            </xsl:call-template>
          </td>
        ...
        <tr>
          ...
          <td class="metavalue">
            <xsl:call-template name="mailLink">
              <xsl:with-param name="nodes" select="./metadata/emails/email" />
              <xsl:with-param name="next" select="'&lt;br /&gt;'"/>
            </xsl:call-template>
          </td>
        </tr>
      ...
      <xsl:if test="./metadata/references">
        <tr>
          ...
          <td class="metavalue">
            <xsl:call-template name="webLink">
              <xsl:with-param name="nodes" select="./metadata/references/reference" />
              <xsl:with-param name="next" select="'&lt;br /&gt;'"/>
            </xsl:call-template>
          </td>
        </tr>
      ...
      <xsl:if test="./metadata/publications">
        <tr>
          ...
          <td class="metavalue">
            <xsl:call-template name="printI18N">
              <xsl:with-param name="nodes" select="./metadata/publications/publication" />
              <xsl:with-param name="next" select="'&lt;br /&gt;'"/>
            </xsl:call-template>
          </td>
        </tr>
