...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation"
    ...
    <xsl:variable name="MainTitle" select="i18n:translate('indexpage.documents.maintitle')" />
      ...
      '&amp;subselect.webpage=', encoder:encode($subselect.webpage),'&amp;mode=',$mode)" />
        <tr>
            ...
            <td class="td1" valign="top" style="padding-right:5px;">
                <a href="{$url}&amp;_var_@xlink:href={col[@name='id']}&amp;_var_@xlink:title={col[@name='title']}">
    ...
    <!-- ========== Titel ========== -->
    <xsl:variable name="IndexTitle" select="i18n:translate('indexpage.documents.indextitle')" />
