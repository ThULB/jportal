...
<!-- ============================================== -->
<!-- $Revision: 789 $ $Date: 2009-03-13 16:09:51 +0100 (Fri, 13 Mar 2009) $ -->
<!-- ============================================== -->
<xsl:stylesheet version="1.0"
	...
	<!-- the template                                   -->
	<!-- ============================================== -->
	<xsl:template name="template_DublicateFinder">
		<xsl:param name="journalsMaintitle"
			select="'Dublettenfinder'" />
		...
		<html>
			<head>
				...
				<link
					href="{$WebApplicationBaseURL}templates/master/template_DublicateFinder/CSS/style_general.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_DublicateFinder/CSS/style_content.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_DublicateFinder/CSS/style_navigation.css"
					rel="stylesheet" type="text/css" />
				<link
				...
				<script language="JavaScript"
					...
					type="text/javascript" />
				<script language="JavaScript"
					src="{$WebApplicationBaseURL}templates/master/template_DublicateFinder/JS/activelink.js"
					type="text/javascript" />	
					...
					<table width="100%" height="156" border="0"
						...
						<tr valign="TOP">
							...
							<td colspan="2" width="max" height="121"
								style="background:url({$WebApplicationBaseURL}templates/master/template_DublicateFinder/IMAGES/18th-header-right.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
						...
						<tr>
							<td width="max" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/template_DublicateFinder/IMAGES/18th-header-right2.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
							<td width="11" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/template_DublicateFinder/IMAGES/18th-header-right3.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
									...
									<div id="contentArea">
										<div id="contentWrapper">
											<xsl:call-template
												name="getFastWCMS" />
											<xsl:call-template
												name="template_DublicateFinder.write.content" />
										</div>
									</div>
								</td>
						</tr>
	...
	<xsl:template name="template_DublicateFinder.write.content">
		<div class="headline">
	...
	<xsl:template name="template_DublicateFinder.userInfo">
		...
		<table class="login_window" border="0" cellspacing="0"
			...
			<tr>
				...
				<td class="login_window">
					...
					<a href="{$LoginURL}">
						<img
							src="{$WebApplicationBaseURL}templates/master/template_DublicateFinder/IMAGES/login-switch.gif"
							border="0" />
					</a>
				</td>
				<td class="login_text">
