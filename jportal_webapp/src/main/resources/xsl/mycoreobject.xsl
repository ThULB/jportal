...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
  xmlns:mcr="xalan://org.mycore.common.xml.MCRXMLFunctions" xmlns:acl="xalan://org.mycore.access.MCRAccessManager" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation"
  ...
  <xsl:template match="/mycoreobject" mode="parent" priority="0">
    ...
    <xsl:if test="./structure/parents">
      <div id="parent" title="{i18n:translate('metaData.linkTo.parent')}">
  ...
  <xsl:template match="internals">
    <xsl:if test="$objectHost = 'local'">
      ...
      <xsl:variable name="derivifs" select="concat($derivbase,mcr:encodeURIPath($derivmain),$HttpSession)" />
      ...
      <xsl:variable name="ftype" select="document('resource:FileContentTypes.xml')/FileContentTypes/type[@ID=$ctype]/label" />
