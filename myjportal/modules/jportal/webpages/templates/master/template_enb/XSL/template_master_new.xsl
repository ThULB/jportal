...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <!-- the template                                   -->
    <!-- ============================================== -->
    <xsl:template name="template_master_new">
                            ...
                            <table height="100%" cellspacing="0" cellpadding="0">
                                <tr valign="top">
                                    <td width="200px" valign="top"
                                        style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/master_new-navi-top.jpg) no-repeat;">
                                ...
                                <tr>
                                    <td style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/master_new-navi-filler.jpg); background-repeat: repeat-y; height: 500px;">
                                        <br />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div id="content-whitespace">
                                <div id="contentArea">
                                    <div id="contentWrapper">
                                        <xsl:call-template name="template_master_new.write.content" />
                                    </div>
                                </div>
                            </div>
                        </td>
    ...
    <xsl:template name="template_master_new.write.content">
        <xsl:call-template name="jp.layout.getHTMLContent" />
    </xsl:template>

    <!-- Template for User info ================================================================================ -->
    <xsl:template name="template_master_new.userInfo">
