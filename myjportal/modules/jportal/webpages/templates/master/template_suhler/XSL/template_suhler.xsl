                            ...
                            <table cellspacing="0" cellpadding="0" border="0" style="height:90%;">
                                ...
                                <tr>
                                    <td id="div_navi_main_middleb">
                                        <a href="http://zs.thulb.uni-jena.de/content/main/journals/henneberger.xml" target="_self">
                                            <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_suhler_navi_middle1.gif" border="0" />
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td id="div_navi_main_middlea"
                                        style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_suhler_navi_middle2.gif) no-repeat;">
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                    <td id="div_navi_main_bottom"
                                        style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_suhler_navi_bottom.gif); background-repeat: repeat-y;">
                                        <br />
                                    </td>
                                </tr>
                            </table>
