        ...
        <html>
            ...
            <body>
                <table cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td colspan="4" bgcolor="#DBDFE7" height="10" style="padding:0px; margin:0px; border:0px; border-style:none">
                            <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" alt="placeholder" border="0" />
                        </td>
                    </tr>
                    <tr>
                        <td width="20px" bgcolor="#DBDFE7" style="border-bottom:1px solid; border-bottom-color:#2D4F97; padding:0px; margin:0px">
                            <img width="20px" src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" border="0" />
                        </td>
                        ...
                        <td>
                            <table cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="100%" style="border-bottom:1px solid; border-bottom-color:#2D4F97; padding:0px; margin:0px">
                                        ...
                                        <table style="width: 380px; padding:0px; border:0px; margin:0px; border-collapse:collapse">
                                            <tr>
                                                <td style="border:none; padding:0px; margin:0px">
                                                    <img width="30px" src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/table_schraeg1.gif"
                    ...
                    <tr>
                        <td width="20px" bgcolor="#DBDFE7" height="110" style="border-top:3px solid; border-color:#DBDFE7"
                            background="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/bg_table_td3.jpg" valign="top">
                            <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" border="0" />
                        </td>
                        <td width="217px" rowspan="3" valign="top" bgcolor="#2F4E9E" style="padding-top:6px">
                            <a>
                                ...
                                <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/logo1.gif" alt="Logo" border="0" />
                            </a>
                        </td>
                        <td colspan="2" bgcolor="#DBDFE7" style="width: 100%; border-top:3px solid; border-color:#DBDFE7"
                            background="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/bg_table1.jpg" valign="top">
                            <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/zfbblogo.gif" alt="Logo" id="logo" border="0" align="right" />
                        </td>
                    </tr>
                    <tr>
                        <td width="20px" bgcolor="#BDCBDD" height="25" style="padding:0px; margin:0px">
                            <img width="20px" src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" border="0" />
                        </td>
                    ...
                    <tr>
                        <td width="20px" bgcolor="#DBDFE7" height="20" style="padding:0px; margin:0px">
                            <img width="20px" src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" border="0" />
                        </td>
                        <td colspan="2" bgcolor="#DBDFE7">
                            <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/placeholder.gif" alt="placeholder" border="0" />
                        </td>
                    </tr>
                    <tr>
