                    ...
                    <tr class="max">
                        ...
                        <td id="mainLeftColumn">
                            <a>
                                ...
                                <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/logo1.jpg" alt="Logo" id="logo" />
                            </a>
                                    ...
                                    <td>
                                        <div class="user_change">
										    ...
										    <xsl:value-of select="$LoginURL" />:
                                                ...
                                                <img src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/changer.gif" alt="Benutzer wechseln"
                                                    id="changer" />
                                            </a>
                                        </div>
                                    </td>
                        ...
                        <td class="max autowidth">
                            <table class="max" cellspacing="0" cellpadding="0"
                                style="background: url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/logo2.jpg) no-repeat;">
