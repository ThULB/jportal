               ...
               <!-- <div id="transparent-logo" /> -->
                ...
                <div style="height: max; width: max;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:transparent;">
                        <tr valign="top">
                            <td width="860" height="156" style="background:url({$WebApplicationBaseURL}templates/master/template_addrBookTh/IMAGES/abt-logo.png) no-repeat; background-color: #5a5720" />
                        </tr>
                        <tr>
                          <td> 
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="220" height="58" style="background:url({$WebApplicationBaseURL}templates/master/template_addrBookTh/IMAGES/abt-navi-top.png) no-repeat;" />
                                <td style="padding-left:35px; padding-right:35px;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td height="5" style="background:url({$WebApplicationBaseURL}templates/master/template_addrBookTh/IMAGES/abt-line.png) repeat-x;"/>
                                    </tr>
                                  </table>
                                </td>
                              </tr>
        ...
        <table class="login_window" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="login_window">
                    ...
                    <a href="{$LoginURL}">
                        <img src="{$WebApplicationBaseURL}templates/master/template_addrBookTh/IMAGES/login-switch.gif" border="0" />
                    </a>
                </td>
                <td class="login_text">
