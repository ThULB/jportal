...
<xsl:template name="template_suz">
	...
	<div id="border">
	   <div id="footer1">
		...
		<div id="footer2">
			<div id="footer2_left">
				<div id="div_navi_main" style="background : url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/suz_bg_nav2.gif); background-repeat: repeat-y;">
					<xsl:call-template name="Navigation_main"/>		
				</div>
				<div id="footer_bottom" style="background : url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/suz_bg_nav3.gif); background-repeat: repeat-x;"></div>
			</div>
			<div id="navi_history">
