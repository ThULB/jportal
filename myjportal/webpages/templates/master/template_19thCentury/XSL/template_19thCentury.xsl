	...
	<xsl:param name="journalsMaintitle"
		...
		<html>
			<head>
				...
				<link
					href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_general.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_content.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_navigation.css"
					rel="stylesheet" type="text/css" />
				<link
				...
				<script language="JavaScript"
					...
					type="text/javascript" />
				<script language="JavaScript"
					src="{$WebApplicationBaseURL}templates/master/template_19thCentury/JS/activelink.js"
					type="text/javascript" />
			</head>
			<body>
				<div id="time">
					...
					<table width="100%" height="156" border="0"
						...
						<tr valign="TOP">
							...
							<td colspan="2" width="max" height="121"
								style="background:url({$WebApplicationBaseURL}templates/master/template_19thCentury/IMAGES/19th-header-right.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
						...
						<tr>
							<td width="max" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/template_19thCentury/IMAGES/19th-header-right2.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
							<td width="11" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/template_19thCentury/IMAGES/19th-header-right3.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
							...
							<td width="200px" valign="top"  rowspan="2">
								...
								<div id="thulb_logo">
									<a
										...
										<img
											src="{$WebApplicationBaseURL}templates/master/template_19thCentury/IMAGES/thulb_logo.png"
											border="0">
										</img>
									</a>
								</div>
									...
									<div id="contentArea">
										<div id="contentWrapper">
											<xsl:call-template
												name="getFastWCMS" />
											<xsl:call-template
												name="template_19thCentury.write.content" />
										</div>
									</div>
								</td>
						</tr>
		...
		<table class="login_window" border="0" cellspacing="0"
			...
			<tr>
				...
				<td class="login_window">
					...
					<a href="{$LoginURL}">
						<img
							src="{$WebApplicationBaseURL}templates/master/template_19thCentury/IMAGES/login-switch.gif"
							border="0" />
					</a>
				</td>
				<td class="login_text">
