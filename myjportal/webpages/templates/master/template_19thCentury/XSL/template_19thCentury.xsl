    ...
    <xsl:template name="template_19thCentury">
        ...
        <html>
            <head>
                ...
                <link href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_general.css" rel="stylesheet" type="text/css" />
                <link href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_content.css" rel="stylesheet" type="text/css" />
                <link href="{$WebApplicationBaseURL}templates/master/template_19thCentury/CSS/style_navigation.css" rel="stylesheet" type="text/css" />
                ...
                <script language="JavaScript" src="{$WebApplicationBaseURL}templates/master/template_19thCentury/JS/activelink.js" type="text/javascript" />
