...
<!-- the template                                   -->
<!-- ============================================== -->
<xsl:template name="template_phil_V">
    <html>
	<head>
	   ...
	   <div id="footer1">
		<div id="border">
			<div id="login_div" style="	background : url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/login.gif) no-repeat;"> 
	            <xsl:call-template name="template_phil_V.userInfo"/>		
			    </div>
			<div id="navigation">
		 ...
		 <br/>
		   <div id="contentArea">
        		...
        		<xsl:call-template name="template_phil_V.write.content"/>
	  	</div>  	  
  	  	</div>
	</body>
    </html>
...
<xsl:template name="template_phil_V.write.content">
   <div class="headline">
...
<xsl:template name="template_phil_V.userInfo">
