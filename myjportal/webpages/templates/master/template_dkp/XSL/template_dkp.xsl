			...
			<body>
						<table cellspacing="0" cellpadding="0" id="footer">
							<tr>
								...
								<td
									style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_dkp_top_right.gif) no-repeat;">
									<table cellspacing="0" cellpadding="0" width="620px">
										<tr>
											...
											<td width="80px">
												<div id="thulb_logo"> <a href="http://www.thulb.uni-jena.de"
														target="_blank"> <img
					...
					<div id="second-line">
					<div id="div_navi_main"	style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_dkp_navi_top.gif) no-repeat;">
						<br/>
