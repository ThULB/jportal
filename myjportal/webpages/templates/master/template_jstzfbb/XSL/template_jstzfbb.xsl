                ...
                <table cellspacing="0" cellpadding="0" style="width: max; height: 100%; border:1px; border-style:none solid none solid; border-color:#000000; margin: 0px 15px; background-color: #dbdfe7; padding:0px;">
                    ...
                    <tr>
                        ...
                        <td width="217px" valign="top" bgcolor="#2F4E9E">
                            <xsl:call-template 
                                name="template_jstzfbb.userInfo"/>
                        </td>
                        ...
                        <td align="right">
                            <table style="padding:0px; border:0px; margin:0px; border-collapse:collapse">
                                <tr>
                                    <td 
                    ...
                    <tr>
                        <td width="20px" bgcolor="#DBDFE7" height="110" 
                            style="border-top:3px solid; border-color:#DBDFE7" 
                        ...
                        <td width="217px" rowspan="3" valign="top" 
                            bgcolor="#2F4E9E" style="padding-top:6px">
                            <a>
                        ...
                        <td colspan="2" bgcolor="#DBDFE7" style="border-top:3px solid; border-color:#DBDFE7"  background="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/bg_table1.jpg" valign="top">
                    ...
                    <tr>
                        ...
                        <td colspan="2" valign="top" id="contentArea">
                            ...
                            <div id="contentWrapper">
                                ...
                                <xsl:call-template 
                                    name="template_jstzfbb.write.content"/>
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <table cellspacing="0" cellpadding="0" class="user">
            <tr>
                ...
                <td class="user_changeButton">
                    <a href="{$LoginURL}">
                        <img 
                            src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/loginDarts.gif" 
                            border="0"/>
                    </a>
                </td>
            </tr>
