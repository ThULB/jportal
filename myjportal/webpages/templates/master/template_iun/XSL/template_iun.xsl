...
<!-- the template                                   -->
<!-- ============================================== -->
<xsl:template name="template_iun">
    <html>
	<head>
	...
	<body>
	   ...
	   <div id="footer1">
		<div id="border">
		    ...
		    <div id="banner">
			<div id="banner_left" style="	background : url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/banner_top_left.gif) no-repeat;">
			<div id="login_div"> 
	            <xsl:call-template name="template_iun.userInfo"/>		
			    </div>
			</div>
			<div id="banner_right">
				...
				<img
					...
					width="735" height="140" alt="Universit�t Ilmenau"
		 ...
		 <div id="div_navi_main">
     	 <xsl:call-template name="Navigation_main"/>		
     	   ...
     	   <div id="navi_under" style="	background : url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/navi_below.gif) repeat-y;">
		   </div>
		   </div>
		 <div id="navi_history">
		 ...
		 <div id="contentArea">
        		...
        		<xsl:call-template name="template_iun.write.content"/>
	  	</div>  	  
  	  	</div>
	</body>
    </html>
...
<xsl:template name="template_iun.write.content">
   <div class="headline">
...
<xsl:template name="template_iun.userInfo">
