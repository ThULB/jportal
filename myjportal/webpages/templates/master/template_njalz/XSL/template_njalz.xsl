...
<xsl:template name="template_njalz">
	...
	<body>
		...
		<tr>
		    ...
		    <td class="menu_column"><p/></td>
		    <td class="conten_column"><p/></td>
		</tr>
		...
		<tr>				
			...
			<table border="0" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
				<td>
				    <img class="jahr" src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/jahr.gif" alt="Seit 1874 bis 1978"/>
				</td>
			    </tr>
			    <tr>
				<td class="empty_box"/>
