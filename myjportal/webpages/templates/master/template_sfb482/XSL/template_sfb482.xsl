	...
	<xsl:template name="template_sfb482">
		<html>
			<head>
				...
				<link
					href="{$WebApplicationBaseURL}templates/master/template_sfb482/CSS/style_general.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_sfb482/CSS/style_content.css"
					rel="stylesheet" type="text/css" />
				<link
					href="{$WebApplicationBaseURL}templates/master/template_sfb482/CSS/style_navigation.css"
					rel="stylesheet" type="text/css" />
				<link
			...
			<body>
				...
				<table width="100%" height="139" border="0"
					...
					<tr>
						<td
							style="background-color: #d8d9da; border-bottom: 4px solid #84aed2;">
							<div id="navi_history">
								<xsl:call-template
						...
						<td width="200px" valign="top" rowspan="2">
							...
							<div id="thulb_logo">
								<a href="http://www.thulb.uni-jena.de"
									target="_blank">
									<img
										src="{$WebApplicationBaseURL}templates/master/template_sfb482/IMAGES/thulb_logo.png"
										border="0">
									</img>
								</a>
							</div>
							<div id="dfg_logo">
								<a href="http://www.dfg.de"
									target="_blank">
									<img
										src="{$WebApplicationBaseURL}templates/master/template_sfb482/IMAGES/dfg_logo.png"
										border="0">
									</img>
								</a>
							</div>
							...
							<div id="contentArea">
								<div id="contentWrapper">
									<xsl:call-template
										name="getFastWCMS" />
									<xsl:call-template
										name="template_sfb482.write.content" />
								</div>
							</div>
						</td>
					</tr>
		...
		<table class="login_window" border="0" cellspacing="0"
			...
			<tr>
				...
				<td class="login_window">
					...
					<a href="{$LoginURL}">
						<img
							src="{$WebApplicationBaseURL}templates/master/template_sfb482/IMAGES/login-switch.gif"
							border="0" />
					</a>
				</td>
				<td class="login_text">
