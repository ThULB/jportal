...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="template_18thCentury">
		<html>
			...
			<body>
				<div
					style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/18th-logo.png) no-repeat; position:absolute; top:37px; right:30px; width:447px; height:171px;" />
					...
					<table width="100%" height="156" border="0"
						...
						<tr valign="TOP">
							<td rowspan="2" width="979"
								style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/18th-header-left.png) no-repeat;">
								<br />
							</td>
							<td colspan="2" width="max" height="121"
								style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/18th-header-right.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
						...
						<tr>
							<td width="max" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/18th-header-right2.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
							<td width="11" height="35"
								style="background:url({$WebApplicationBaseURL}templates/master/{$template}/IMAGES/18th-header-right3.png) no-repeat;">
								<p>
									<br />
								</p>
							</td>
		...
		<table class="login_window" border="0" cellspacing="0"
			...
			<tr>
				...
				<td class="login_window">
					...
					<a href="{$LoginURL}">
						<img
							src="{$WebApplicationBaseURL}templates/master/{$template}/IMAGES/login-switch.gif"
							border="0" />
					</a>
				</td>
				<td class="login_text">
