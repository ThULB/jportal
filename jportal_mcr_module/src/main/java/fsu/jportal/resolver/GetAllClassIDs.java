...
public class GetAllClassIDs implements URIResolver {

    private static final Logger LOGGER = Logger.getLogger(GetAllClassIDs.class);

    private String URI = "getALLClassIDs:";
    ...
    public GetAllClassIDs() {
        categDAO = MCRCategoryDAOFactory.getInstance();
    }
    
    public GetAllClassIDs(MCRCategoryDAO dao) {
        categDAO = dao;
    }
