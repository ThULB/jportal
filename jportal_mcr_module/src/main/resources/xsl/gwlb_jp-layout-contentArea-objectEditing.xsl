...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation"
  ...
  <xsl:template name="jp.object.editing.items">
    ...
    <xsl:if test="/mycoreobject[contains(@ID,'_jpjournal_')] or /MyCoReWebPage/section/jpindex ">
      <script type="text/javascript" src="{$WebApplicationBaseURL}webjars/ckeditor/4.5.3/full/ckeditor.js" />
      <script type="text/javascript" src="{$WebApplicationBaseURL}webjars/ckeditor/4.5.3/full/adapters/jquery.js" />
