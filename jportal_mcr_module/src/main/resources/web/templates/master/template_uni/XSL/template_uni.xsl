...
<!-- ============================================== -->
<!-- $Revision: 1142 $ $Date: 2010-09-06 11:16:02 +0200 (Mo, 06 Sep 2010) $ -->
<!-- ============================================== -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <!-- the template                                   -->
    <!-- ============================================== -->
    <xsl:template name="template_uni">
        <html>
            <head>
                ...
                <div id="footer1">
                    ...
                    <div id="banner">
                        <div id="banner_left"
                            ...
                            <div id="login_div">
                                <xsl:call-template name="template_uni.userInfo" />
                            </div>
                        </div>
                        <div id="banner_right">
                        ...
                        <tr>
                            ...
                            <td valign="top" id="footer2-right">
                                ...
                                <div id="contentArea">
                                    ...
                                    <xsl:call-template name="template_uni.write.content" />
                                </div>
                            </td>
                        </tr>
                    </table>
    ...
    <xsl:template name="template_uni.write.content">
        <xsl:call-template name="jp.layout.getHTMLContent" />
    </xsl:template>

    <!-- Template for User info ================================================================================ -->
    <xsl:template name="template_uni.userInfo">
