...
public class MODSLogoResourceTest extends MCRJerseyResourceTest {
    public static class MyDataStore extends MCRMetadataStore {
        ...
        protected MCRStoredMetadata createMetadataMock(String metadataType, int id) throws IOException, JDOMException, SAXException {
            ...
            expect(journalMetadataMock.isDeleted()).andReturn(false);
