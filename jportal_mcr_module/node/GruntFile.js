module.exports = function(grunt) {
  ...
  var uglifyFiles = function() {
    var uglifyFiles = {};
    uglifyFiles["classes/META-INF/resources/modules/iview2/js/" + config.moduleName + "-module.min.js"] = "classes/META-INF/resources/modules/iview2/js/"
  ...
  var processFiles = function(content, srcpath) {
     ...
     * 
     * config.iviewDependencys contains all dependencies if if a reference path
     * found wich contains dependencyName it will be replaced with the d.ts
     * file. You can refer to the original file (for autocomplete of the ide)
    ...
    uglify: {
      example: {
        ...
        options: {
          mangle: true,
          sourceMap: true,
          sourceMapIn: "classes/META-INF/resources/modules/iview2/js/" + config.moduleName + "-module.js.map"
        }
      }
    },
    copy: {
