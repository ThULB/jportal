...
public class ConfigurationDir {
    ...
    private static String getSource(Class<ConfigurationDir> clazz) {
        if (clazz == null) {
            return null;
        }
    ...
    private static String buildAppName() {
        ...
        String sourceFileName = getSource(ConfigurationDir.class);
    ...
    public static URL getConfigResource(String relativePath, ClassLoader classLoader) {
        ...
        if (resolvedFile != null && resolvedFile.exists()) {
            try {
                ...
                Logger.getLogger(ConfigurationDir.class).warn(
    ...
    private static URL getClassPathResource(String relativePath, ClassLoader classLoader) {
        ...
        if (SERVLET_CONTEXT != null && currentUrl != null) {
            ...
            try {
                ...
                Logger.getLogger(ConfigurationDir.class)
